...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Visualize correct/error separability and trajectory dynamics for prompt-control-flow metrics.")
    p.add_argument("--input", required=True, help="Metric npz from extract_prompt_flow.py")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    print(f"Wrote prompt-flow visualizations to {args.output_dir}")
