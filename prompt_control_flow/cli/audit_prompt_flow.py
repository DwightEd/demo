...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Audit prompt-control-flow extracted metrics.")
    ap.add_argument("--input", required=True, help="Metric npz from extract_prompt_flow.py")
