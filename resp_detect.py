...
def main():
    ...
    for nm, v in [("GDIS (kappa-dyn)", G_gdis), ("min-kappa", G_mink), ("mean-kappa", G_meank),
                  ("kappa-var", G_kvar), ("EDIS (entropy)", E_edis), ("mean-entropy", E_mean)]:
